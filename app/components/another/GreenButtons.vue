<template>
  <div class="w-full h-24 flex justify-center items-center md:px-5  gap-5">
    <button
      v-for="(link, index) in links"
      :key="index"
      @click="NavigationPage(link.page)"
      class="w-xl md:w-42 h-10  md:h-12 text-center content-center rounded duration-400 bg-[rgb(59,123,132)] text-white relative hover:bg-[rgb(48,100,107)]  text-xs md:text-lg ease-in-out cursor-pointer"
