<template>
  <div class="w-full h-24 flex justify-center items-center md:px-5 gap-5">
    <button
      ...
      class="md:w-42 w-4xl h-10 text-center content-center rounded transition bg-[rgb(59,123,132)] text-white relative hover:bg-[rgb(48,100,107)]   ease-in-out cursor-pointer"
